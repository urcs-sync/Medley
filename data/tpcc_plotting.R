...
read.csv("./tpcc.csv",row.names=NULL)->montagedata
...
linchart<-ggplot(data=lindata,
  ...
  coord_cartesian(xlim = c(-2, 80), ylim = c(y_range_down,1000000))+
...
ggsave(filename = "./tpcc.pdf",linchart,width=4, height = 3, units = "in", dpi=300, title = "tpcc.pdf")